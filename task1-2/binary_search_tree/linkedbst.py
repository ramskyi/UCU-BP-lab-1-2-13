    ...
    def successor(self, item):
        ...
        while current is not None:
            if current.data > item:
                ...
                current = current.right
        if last is not None and last > item:
            return last
...
def test():
    """Shows that class LinkedBST works perfectly
    """
    tree = LinkedBST([4, 5, 1, 3, 7, 9, 2, 0, 6])
    print(tree)
    tree.rebalance()
    print(tree)
    ...
    for i in range(-1, 11):
        print(i, tree.predecessor(i))
    print()
    for i in range(-1, 11):
        print(i, tree.successor(i))
    print()
    print(tree.rangeFind(3, 8))

    tree = LinkedBST(range(0, 10))
    print(tree)
    print('balanced =', tree.isBalanced())
    tree.rebalance()
    print(tree)
